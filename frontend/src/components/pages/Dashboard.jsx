                ...
                <section className="h-auto max-w-4xl text-center m-6 md:m-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-4">
                        <div className="bg-white text-black rounded-md p-6 shadow-lg">
                            ...
                            <h3 className="text-xl font-bold mb-2">Variety of Fitness Classes</h3>
                            <p className="text-lg">Access a wide range of classes to suit your fitness level and goals.</p>
                        </div>
                        <div className="bg-white text-black rounded-md p-6 shadow-lg">
    ...
    if (isAuthenticated && user.userRole === 'user') {
        return (
            <div className="pt-[1rem]">
                ...
                <button data-drawer-target="default-sidebar" data-drawer-toggle="default-sidebar" aria-controls="default-sidebar" type="button" class="pt-16 inline-flex items-center p-2 mt-2 ms-3 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
                ...
                <aside className="w-64 bg-gray-800 text-white">
                    ...
                    <nav className="p-4">
                        <ul>
                            ...
                            <li className="mb-2">
                                <Link to="/admin/classes" className="hover:bg-gray-700 p-2 block">Manage Classes</Link>
                            </li>
                            <li className="mb-2">
